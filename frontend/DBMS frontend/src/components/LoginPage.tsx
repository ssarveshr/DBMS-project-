...
const LoginPage:FunctionComponent = () => {
  	return (
    		<div className={styles.loginPage}>
				...
				<div>
								<p><img className={styles.unionIcon} alt="Union Icon" src="/union-1.svg"/></p>
								<p> <img className={styles.unionIcon1} alt="Union Icon 1" src="/union-2.svg"/></p>
								<p><img className={styles.unionIcon2} alt="Union Icon 2" src="/union-3.svg"/></p>
          						</div>
